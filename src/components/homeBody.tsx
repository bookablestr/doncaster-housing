  ...
  return (
    <div className=" lg:py-16 py-10">
      <div className="flex lg:px-12 px-6 flex-col justify-center items-center gap-6">
        ...
        <div className="font-raleway grid lg:grid-cols-4 lg:px-12 px-6 grid-cols-2 gap-10">
          {features.map((feat, index) => (
            ...
            >
              ...
              <p className="text-2xl lg:text-3xl text-center pb-6 py-8">
                {feat.text}
              </p>
            </div>
          ))}
      ...
      <div className="font-raleway text-[#FFFBFB] text-2xl relative">
        {/* first bg */}
        <div className="absolute -mt-4 inset-0 bg-[#CCE9FF] py-10 z-0"></div>
        {/* second */}
        <div className="py-6 custom-gradient relative font-bold flex gap-10 justify-center items-center">
          <p>No booking fees</p>
          <div className="rounded-md p-3 bg-[#FFFBFB]"></div>
